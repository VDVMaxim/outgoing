...
export 'package:flutter_clubapp/features/vibe/presentation/providers/vibe_provider.dart'
    show VibeDisplayData;
                ...
                children: [
                  ...
                  if (vpData.vpForNextLevel > 0)
                    Text(
                      AppLocalizations.of(
                        context,
                      )!.vpToNextLevel(vpData.vpForNextLevel),
                      style: TextStyle(
                        fontSize: 12,
