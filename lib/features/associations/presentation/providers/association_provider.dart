...
import 'package:flutter_clubapp/features/associations/domain/association_repository.dart';
import 'package:flutter_clubapp/features/associations/data/supabase_association_repository.dart';
...
class AssociationNotifier extends AsyncNotifier<AssociationState> {
  ...
  Future<AssociationState> _fetchData() async {
    ...
    try {
      ...
      final associations = (assocResponse as List)
      ...
      if (userId != null) {
        ...
        userAssocs = (membershipResponse as List)
...
final associationProvider =
    AsyncNotifierProvider<AssociationNotifier, AssociationState>(() {
