...
class SettingsService {
  ...
  Future<void> setHapticsEnabled(bool value) => _notifier.setHapticsEnabled(value);

  int get trackingFrequency => _state.trackingFrequency;
  Future<void> setTrackingFrequency(int value) => _notifier.setTrackingFrequency(value);

  int get offlineMultiplier => _state.offlineMultiplier;
  Future<void> setOfflineMultiplier(int value) => _notifier.setOfflineMultiplier(value);
}
